...
namespace promad.Controllers
{
    ...
    {
        private readonly promadContext _context;

        public ProductoesController(promadContext context)
        {
            _context = context;
        }
        ...
        {
            var promadContext = _context.Productos.Include(p => p.IdProveedorNavigation);
            return View(await promadContext.ToListAsync());
        }
        ...
        {
            ViewData["IdProveedor"] = new SelectList(_context.Proveedores, "IdProveedor", "Codigo");
            return View();
        }
